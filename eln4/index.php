...
<!-- vue : single app -->
	...
	<div id="app" >
    <router-link id="routerlink" to="/">Home</router-link>
		<router-link id="routerlink" to="/users/123/profile">Profile</router-link>
    <router-link id="routerlink" to="/users/123/user">Coopelation</router-link>
	...
	<div class="container">
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 uix-t-l uix-mobile-tc">
							...
							Copyright &copy; 2020.  |  All rights reserved. Created by </br><a href="">koichi hatakeyama</a>.
						</div>
						</div>
					</div>
